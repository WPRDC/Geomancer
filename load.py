...
def run(verbose=True):
    global mapping
    # subprocess.run(['psql', 'django', '-c', 'TRUNCATE geoservices_adminregion cascade'])
    # subprocess.run(['psql', 'django', '-c', 'TRUNCATE geoservices_parcel'])
    subprocess.run(['psql', 'django', '-c', 'TRUNCATE geoservices_addresspoint'])
